<template>
  <main v-if="!loading" id="hello">
    ...
    <section class="hero">
      ...
      <div id="info">
        <span class="action">
          // This website was built in Next.js and MaterialUI
        </span>
        <span :class="{ hide: isMobile }"> // que sera sera </span>
        <span :class="{ hide: !isMobile }">
          // find my profile on Github:
        </span>
        <p class="code">
          <span class="identifier"> export const </span>
          <span class="variable-name"> RESUME_LINK </span>
          <span class="operator"> = </span>
          <a class="string" href="/resume.pdf"> "/resume.pdf" </a>
        </p>
      </div>
    </section>
    ...
    <section data-aos="fade-up" class="game" v-if="!isMobile">
      <div class="emoji-face">
        <img src="public\icons\Male Memojis.svg" alt="Emoji Face" />
      </div>
    </section>
  </main>
</template>
